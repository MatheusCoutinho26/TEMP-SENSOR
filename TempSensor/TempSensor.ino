// TempSensor: Monitoramento de temperatura com variação de parâmetros
#include <Wire.h>
...
void loop() {
  // Faz a leitura do valor analógico no pino A0 (retorna de 0 a 1023)
  int leituraADC = analogRead(pinoLM35);

  // Converte a leitura do ADC para Tensão em Volts (considerando Arduino a 5V)
  float tensao = leituraADC * (5.0 / 1023.0);

  // Converte a tensão para Temperatura (O LM35 varia 10mV ou 0.01V por grau Celsius)
